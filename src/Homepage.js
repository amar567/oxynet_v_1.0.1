...
export default class Homepage extends Component{
    ...
    sort = async(event) =>{
      ...
      console.log(this.state.data);
      // (val === 'oxygenBedAvailable')?this.state.data.sort((a, b) => (a.oxygenBedAvailable > b.oxygenBedAvailable) ? 1 : -1):null
      // (val === 'normalBedAvailable')?this.state.data.sort((a, b) => (a.normalBedAvailable > b.normalBedAvailable) ? 1 : -1):null
    }
