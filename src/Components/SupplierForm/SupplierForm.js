            ...
            <div className="supplier-form-whole" style={{margin: 'auto'}}>
                <div className="form-inside">
                    ...
                    <div className="input-field">
                        <input defaultValue={this.props.quantity} type="text" className="in-input" placeholder="Quantity (eg. 100 Oxygen Cylinders)"></input>
                    </div>
                    <div className="input-field">
                        <input defaultValue={this.props.cost} type="text" className="in-input" placeholder="Cost (MRP) per cylinder"></input>
                    </div>
                    <div className="input-field">
                        <input defaultValue={this.props.phone1} type="text" className="in-input" placeholder="10 digit Phone Number"></input>
                    </div>
                    <div className="input-field">
                        <input defaultValue={this.props.phone2} type="text" className="in-input" placeholder="Alternate Phone Number"></input>
                    </div>
                    <div className="input-field">
                        <input defaultValue={this.props.shopname} type="text" className="in-input" placeholder="Shop Name"></input>
                    </div>
                    <div className="input-field">
                        <input defaultValue={this.props.shopadd} type="text" className="in-input" placeholder="Shop Address"></input>
                    </div>
                    <div className="input-field">
                        <select name="stateName" style={{'border': '1px solid #FFFFFF','width': '75vw','margin': 'auto','background': '#3E3E40','color': 'white','paddingLeft': '10px','filter': 'drop-shadow(0px 0.5px 4px rgba(0, 0, 0, 0.25))','border-radius': '10px','font-size': '13px'}} id="state" defaultValue={this.props.state} onChange={this.myChangeHandler}>
                            <option value="" disabled >Select state</option>
                            {states.map((state,index) => (<option key={index} name={state}>{state}</option>))}
                        </select>
                    </div>
                    <div className="input-field">
                        <select name="district" style={{'border': '1px solid #FFFFFF','width': '75vw','margin': 'auto','background': '#3E3E40','color': 'white','paddingLeft': '10px','filter': 'drop-shadow(0px 0.5px 4px rgba(0, 0, 0, 0.25))','border-radius': '10px','font-size': '13px'}} id="district" value={this.state.disrtict} onChange={this.handleChange}>
